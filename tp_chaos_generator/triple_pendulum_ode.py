...
def f(t, x, params) -> list:
    ...
    y4 = (2 * (((L1 ** 2) * np.sin(2 * x[0] - 2 * x[1]) * (m2 + 2 * m3) \
        ...
        * (L1 ** 2) * (L2 ** 2) * m1 * m2 +  4 * I2 * (L1 ** 2) * (L3 ** 2) * m1 * m3 \
        ...
        +  16 * I2 * (L1 ** 2) * (L3 ** 2) * m2 * m3  + 48 * I3 * (L1 ** 2) * (L2 ** 2) * m2 * m3 \
        - 8 * I1 * (L2 ** 2) * (L3 ** 2) * (m3 ** 2) * np.cos(2 * x[1] - 2 * x[2]) \
        - 2 * (L1 ** 2) * (L2 ** 2) * np.cos(2 * x[0] - 2 * x[1]) * (m2  + 2 * m3) \
        * (m2 * m3 * (L3 ** 2) + 4 * I3 * (m2 + 2 * m3)) - 2 * (L1 ** 2) * (L3 ** 2) \
    ...
    y5 =  - (2 * (32 * I1 * I2 * k3 * x[5] - L2 * L3 * m3 * (x[4] ** 2) * (np.sin(x[1] - x[2]) \
        ...
        * m2 * x[5] + 32 * I2 * k3 * (L1 ** 2) * m2 * x[5] + 32 * I1 * k3 * (L2 ** 2) * m3 * x[5] \
        +  32 * I2 * k3 * (L1 ** 2) * m3 * x[5] - 4 * k1 * L1 * L3 * m3 * x[3] * (np.cos(x[0] \
        - x[2]) * (2 * m3 * (L2 ** 2)  + 4 * I2) -  (L2 ** 2) * np.cos(x[0] - 2 * x[1] + x[2]) \
        * (m2 + 2 * m3)) - 16 * I1 * I2 * g * L3 * m3 * np.sin(x[2]) -  4 * I2 * (L1 ** 2) \
        * (L3 ** 2) * (m3 ** 2) * (x[5] ** 2) * np.sin(2 * x[0] - 2 * x[2]) - 4 * I1 \
        * (L2 ** 2) * (L3 ** 2) * (m3 ** 2) * (x[5] ** 2) * np.sin(2 * x[1]  - 2 * x[2]) \
        ...
        * ((m1 + 3 * m2 + 2 * m3) * (L1 ** 2) + 4 * I1) -  (L1 ** 2) * np.cos(2 * x[0] - x[1] \
        ...
        - 8 * I2 * g * (L1 ** 2) * L3 * (m3 ** 2) * np.sin(x[2]) - 4 * k3 * (L1 ** 2) * (L2 ** 2) \
        * (m2 ** 2) * x[5] * np.cos(2 * x[0]  - 2 * x[1]) -  16 * k3 * (L1 ** 2) * (L2 ** 2) \
        * (m3 ** 2) * x[5] * np.cos(2 * x[0] - 2 * x[1]) - 8 * I2 * g * (L1 ** 2) \
